...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../lab62.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lab62.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../lab62.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../lab62.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
